        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Data Customer --> */}
              {/* <!-- Menu Item Penjualan Toko --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/transaction-reports' || pathname.includes('transaction-reports') ||
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/transaction-reports' ||
                          pathname.includes('transaction-reports') || pathname === '/products' || pathname.includes('products')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
